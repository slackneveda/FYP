...
const AdminSidebar = ({ isOpen, onClose }) => {
  const adminMenuItems = [
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 5a2 2 0 012-2h4a2 2 0 012 2v0M8 11h6m-6 4h6" />
        </svg>
      )
    },
    {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed top-0 left-0 h-full w-72 sm:w-80 lg:w-64 bg-card border-r border-border z-50 
      ...
      `}>
        ...
        <div className="flex items-center justify-between p-4 border-b border-border flex-shrink-0">
          <h2 className="text-lg lg:text-xl font-bold text-primary truncate">Admin Panel</h2>
          <button
            onClick={onClose}
              ...
              {adminMenuItems.map((item) => (
                <li key={item.path}>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center space-x-3 px-3 py-2.5 lg:px-4 lg:py-3 rounded-lg transition-colors text-sm lg:text-base ${
                        isActive
        ...
        <div className="p-3 lg:p-4 border-t border-border flex-shrink-0">
          <NavLink
            to="/"
            className="flex items-center justify-center space-x-2 px-3 py-2.5 lg:px-4 lg:py-3 
                     bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/80 
                     transition-colors text-sm lg:text-base w-full"
            onClick={() => {
